        ...
        public void Update(string fiscalYear)
        {
            ...
            for (int i = 1; i < 13; i++)
            {
                ...
                foreach (var worksheet in Workbook.Worksheets(fileName))
                {
                    ...
                    if (Worksheet_NO == workbook_number)
                    {
                        ...
                        //for (int iz = 0; iz < 200; iz++)
                        {
                            ...
                            {
                                column_count++;
                                if (column_count < 4 || (i == 1 && (column_count == 6 || column_count == 7)) || ((column_count == 6 || column_count == 10 || column_count == 11))) //name/ actual/ percentage
                                //if (column_count < 4 || (i == 1 && (column_count == 6 || column_count == 7)) || (i == 1 && (column_count == 10 || column_count == 11))) //name/ actual/ percentage
                                {
                                    try 
                                    {
                                        try
                                        {
                                            if (column_count < 4)
                                            {
                                                if (total_found_on_row == 0 && cell.Text.Contains("TOTAL") && !cell.Text.Contains("SALES") && !cell.Text.Contains("SURCHARGE") )
                                                {
                                                    total_found_on_row = row_count;
                                                }
                                                double a = Convert.ToDouble(WORKSHEET_ARRAY[row_count, column_count]);
                                                double b = Convert.ToDouble(cell.Text);
                                                if (row_count == 2) // Get exchange rate
                                                {
                                                    ANNUAL_DATA[i - 1, row_count] = cell.Value.Length > 4 ? cell.Value : cell.Value;
                                                    ...
                                                    //Console.WriteLine("Current Exchange rate: " + current_period_exch_rate);
                                                }
                                                else if (column_count == 2)
                                                {
                                                    ANNUAL_DATA[i - 1, row_count] = cell.Text;
                                                    if (month <= Convert.ToInt32(fiscal_month))
                                                        WORKSHEET_ARRAY[row_count, column_count] = (a + b).ToString();
                                                }
                                                else
                                                {
                                                    ANNUAL_PERCENTAGE[i - 1, row_count] = (Convert.ToDouble(cell.Value)).ToString("P2");
                                                }
                                            }
                                            Console.Write(".");
                                            ...
                                            {
                                                BUDGET_CURRENT_PERIOD[0, row_count] = (Convert.ToDouble(cell.Value)).ToString();/// current_period_exch_rate).ToString();
                                            }
                                            if (i == 1 && column_count == 7)
                                            {
                                                BUDGET_CURRENT_PERIOD[1, row_count] = (Convert.ToDouble(cell.Value)).ToString("P2");
                                            }
                                            ...
                                            //if (i == 1 && column_count == 10 && row_count > 4)
                                            {
                                                ...
                                                if (month <= Convert.ToInt32(fiscal_month))
                                                    ...
                                                    YTD_BUDGET_CURRENT_PERIOD[0, row_count] = (Convert.ToDouble(YTD_BUDGET_CURRENT_PERIOD[0, row_count]) + Convert.ToDouble(cell.Text)).ToString(); // ADD
                                                //if (row_count < 26)
                                                //Console.WriteLine("Ongoing total: " + YTD_BUDGET_CURRENT_PERIOD[0, row_count]);
                                            }
                                            if (i == 1 && column_count == 11 && row_count > 4) //get percentage
                                            {
                                                YTD_BUDGET_CURRENT_PERIOD[1, row_count] = (Convert.ToDouble(cell.Value)).ToString("P2");
                                            }
                                        }
                                        catch
                                        {
            ...
            consolidatedIS.Name = "12-month " + plant_name + " (CAD)";
